...
public class ZZAgent extends TWAgent {
    ...
    public ZZAgent(String name, int xpos, int ypos, TWEnvironment env, double fuelLevel) {
...
//            addScores(scores, ranking, 0, 0, 0, 0);
            ...
            ranking = rankDirections(x, y, fuelStationX, fuelStationY);
            addScores(scores, ranking, -1, -1, 1, 1);
...
//        }
    ...
    private double sumdistance(double xx,double yy,double x0,double y0){
        return Math.sqrt(Math.pow(xx-x0,2)+Math.pow(yy-y0,2));
    }
...
//In test
        //current distance
        //double d=sumdistance(x,y-1,otherAgentLocX[0],otherAgentLocY[0],otherAgentLocX[1],otherAgentLocY[1]);

        //replace the general dir
        System.out.println(Math.sqrt(Math.pow(x-otherAgentLocX[0],2)+Math.pow(y-otherAgentLocY[0],2)));
        System.out.println(Math.sqrt(Math.pow(x-otherAgentLocX[0],2)+Math.pow(y-otherAgentLocY[0],2)));
        System.out.println("_________________________________________________________________");
        if (sumdistance(x,y,otherAgentLocX[0],otherAgentLocY[0])<=50 ||
                sumdistance(x,y,otherAgentLocX[0],otherAgentLocY[0])<=50){
            ...
            // uncomment this to implement keep distance strategy
//            if (mdis==d_up){
//                generalDir[0]=TWDirection.N;
//            }else if (mdis==d_down){
//                generalDir[0]=TWDirection.S;
//            }else if (mdis==d_left){
//                generalDir[0]=TWDirection.W;
//            }else{
//                generalDir[0]=TWDirection.E;
//            }
