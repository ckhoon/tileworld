...
public class CKAgent extends TWAgent {
    ...
    public CKAgent(String name, int xpos, int ypos, TWEnvironment env, double fuelLevel) {
...
//        this.memory = new TWAgentWorkingMemory(this, env.schedule, env.getxDimension(), env.getyDimension());
    ...
    private boolean checkLowFuelLevel() {
        if ((distanceToFuelStation != -1 && fuelLevel <= 1.1 * distanceToFuelStation) || (this.fuelLevel<=50)) {
